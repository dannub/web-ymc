...
<html>
<head>
<title>Young Muslim Creativity</title>
<!-- for-mobile-apps -->
...
<!-- mail -->
	<div class="mail">
		<div class="container">
			<h3>Pendaftaran Young Muslim Creativity</h3>
			<p class="dolor">"Silahkan mendaftar YMC pada formulir di bawah ini"</p>

			<div class="agileits_mail_grids">
				<div class="col-md-8 agileits_mail_grid_left">
					<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdD4JPblac2qPhAKZq6LDo_8z2setLAC8c_xUOALAnUSQwVkA/viewform?usp=sf_link" width="100%" height="1200" style="border:0" allowfullscreen></iframe>
				</div>
